...
const ProductoModal = (props: any) => {

  const formRef = useRef(null);
  const { show, handleClose, handleChange, handleSubmit, isEdit, validate, errorMsg, producto } = props;
  ...
  return (
    ...
    >
      <Modal.Header closeButton>
        <Modal.Title>{isEdit ? 'Editar Producto' : 'Agregar Producto'}</Modal.Title>
      </Modal.Header>
      <Modal.Body>
