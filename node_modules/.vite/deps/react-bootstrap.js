...
var _excluded2 = ["show", "role", "className", "style", "children", "backdrop", "keyboard", "onBackdropClick", "onEscapeKeyDown", "transition", "backdropTransition", "autoFocus", "enforceFocus", "restoreFocus", "restoreFocusOptions", "renderDialog", "renderBackdrop", "manager", "container", "onShow", "onHide", "onExit", "onExited", "onExiting", "onEnter", "onEntering", "onEntered"];
...
var Modal = (0, import_react28.forwardRef)((_ref, ref) => {
  ...
  if (Transition2) {
    dialog = (0, import_jsx_runtime52.jsx)(Transition2, {
      appear: true,
      unmountOnExit: true,
      in: !!show,
      onExit,
  ...
  if (backdrop) {
    ...
    if (BackdropTransition3) {
      backdropElement = (0, import_jsx_runtime52.jsx)(BackdropTransition3, {
        appear: true,
        in: !!show,
...
var Modal2 = React57.forwardRef(({
  ...
  const renderBackdrop = (0, import_react30.useCallback)((backdropProps) => (0, import_jsx_runtime59.jsx)("div", {
    ...backdropProps,
  ...
  const renderDialog = (dialogProps) => (0, import_jsx_runtime59.jsx)("div", {
    ...
    className: (0, import_classnames42.default)(className, bsPrefix, animateStaticModal && `${bsPrefix}-static`),
...
function OverlayTrigger({
  ...
  return (0, import_jsx_runtime77.jsxs)(import_jsx_runtime76.Fragment, {
    children: [typeof children === "function" ? children(triggerProps) : (0, import_react43.cloneElement)(children, triggerProps), (0, import_jsx_runtime75.jsx)(Overlay_default2, {
      ...props,
      show,
      onHide: handleHide,
      flip,
...
var ToastFade = React89.forwardRef((props, ref) => (0, import_jsx_runtime99.jsx)(Fade_default, {
  ...props,
  ref,
